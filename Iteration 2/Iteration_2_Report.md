...
Previous elements worked on in Iteration 1 will be worked on and refined in Iteration 2. Design architectures and diagrams will be used to expanded on the elements.
